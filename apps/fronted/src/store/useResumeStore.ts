...
export const useResumeStore = create<ResumeStore>()(
  persist(
    (set) => ({
      ...
      /*************  ✨ Codeium Command ⭐  *************/
      /**
       * Sets the color theme of the resume.
       *
       * @param {string} colorTheme The color theme to set. It should be a valid CSS color value.
       */
      /******  23718a2c-a32c-41a3-a215-d84d02e13b6f  *******/
