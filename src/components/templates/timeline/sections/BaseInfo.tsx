                ...
                <div className={styles.leftContent}>
                    ...
                    <div className={cn("flex flex-col", styles.nameTitle)}>
                        {nameField.visible !== false && basic[nameField.key] && (
                            <motion.h1 layout="position" className="font-bold whitespace-normal break-normal [overflow-wrap:anywhere]" style={{ fontSize: "30px" }}>{basic[nameField.key] as string}</motion.h1>
                        )}
                        {titleField.visible !== false && basic[titleField.key] && (
                            <motion.h2 layout="position" className="whitespace-normal break-normal [overflow-wrap:anywhere]" style={{ fontSize: "18px" }}>{basic[titleField.key] as string}</motion.h2>
                        )}
                    </div>
                </div>
